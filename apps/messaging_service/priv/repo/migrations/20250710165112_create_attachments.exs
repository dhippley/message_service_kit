defmodule MessagingService.Repo.Migrations.CreateAttachments do
  ...
  def change do
    ...
    create(
      constraint(:attachments, :url_or_blob_check,
    ...
    create(
      constraint(:attachments, :valid_attachment_type,
        check: "attachment_type IN ('image', 'document', 'video', 'audio', 'archive', 'text', 'other')"
      )
    )
